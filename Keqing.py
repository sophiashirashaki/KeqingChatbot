...
print("[KEQING]: Initializing Config Vars ...")
...
print("[KEQING]: Initializing Bot Client ...")
...
async def repo(_, message):
    ...
    await message.reply_text(
        ...
        "[GitHub](https://github.com/sophiashirashaki/KeqingChatbot)"
...
@luna.on_message(filters.command(["help", "help@Keqing_Chatbot"]) & ~filters.edited)
...
async def main():
    ...
    print("[KEQING] Initializing Arq Client ...")
